...
← Anterior: [5.4.1 Perceptrón y MLP](5.4.1-perceptron-y-mlp.md)  
Siguiente: [5.4.3 RNN y LSTM — para secuencias](5.4.3-rnn-y-lstm-para-secuencias.md) →
