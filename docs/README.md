# 📚 Base de Conocimiento — Índice Maestro

Bienvenido a la documentación del doctorado. Organizada en **5 bloques temáticos**, permite consultar tanto la teoría como el código práctico directamente desde GitHub o desde la web del sitio MkDocs.
